        ...
        <div class="calculator-container">
            ...
            {move || {
                if program_generated.get() && has_valid_inputs.get() {
                    view! {
                        <div>
                            <div class="program-description">
                                ...
                                <p>"Monday sessions are always 3-5x5 @ 75% to avoid frying the CNS."</p>
                            </div>
                    ...
                    view! {
                        <div class="waiting-for-input">
                            <div class="program-preview">
                                <h3>"What you'll get:"</h3>
                                <div class="preview-features">
                                    <div class="feature">
                                        <h4>"4-Week Progressive Program"</h4>
                                        <p>"Systematically build strength over 4 weeks"</p>
                                    </div>
                                    <div class="feature">
                                        <h4>"Customized to Your 1RM"</h4>
                                        <p>"All weights calculated from your personal maximums"</p>
                                    </div>
                                    <div class="feature">
                                        <h4>"Week 4 Max Testing"</h4>
                                        <p>"Test new PRs up to 105% of current max"</p>
                                    </div>
                                </div>
                            </div>
                        </div>
